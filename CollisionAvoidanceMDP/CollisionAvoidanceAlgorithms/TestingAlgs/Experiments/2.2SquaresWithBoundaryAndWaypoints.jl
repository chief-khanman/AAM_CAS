...
############## settings ##############
filename = "2.2SquaresWithBoundaryAndWaypoints"
...
circle = Circle(Cartesian2(5000.0, 5000.0), 1000.0)
addShape!(sm_restricted, circle, 1)

# generate 4 "lanes" of waypoints that go around the RA. This may reduce NMAC
points = [  
            Cartesian2(5000.0, 3000.0),
            Cartesian2(5000.0, 7000.0),
]
...
######################################
stats, video = length(stats_algs) > 0, length(video_algs) > 0
