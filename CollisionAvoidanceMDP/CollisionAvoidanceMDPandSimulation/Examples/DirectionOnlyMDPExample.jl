...
for _ in 1:10
    ...
    while !done
        ...
        local r = ReinforcementLearningBase.reward(transformed_env)
        ...
        action = [clamp(s[1], -transformed_env.env.airspace.maximum_aircraft_acceleration.θ, transformed_env.env.airspace.maximum_aircraft_acceleration.θ)]
